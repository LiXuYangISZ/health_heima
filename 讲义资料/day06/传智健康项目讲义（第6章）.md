...
![8](https://s2.loli.net/2021/12/05/O2rEWwU5vCmxaRB.png)

![11](https://s2.loli.net/2021/12/05/Q3MeAstuhR5mSYJ.png)
...
![9](https://s2.loli.net/2021/12/04/tYHmz4UaekRicbN.png)

选择订阅号进行注册：

![10](https://s2.loli.net/2021/12/04/bc7Tnikp8j9WMlD.png)
...
![12](https://s2.loli.net/2021/12/05/cSqPJNmtuWxKabg.png)
...
![2](https://s2.loli.net/2021/12/04/ZyHF2ECOlpRBkeM.png)



![3](https://s2.loli.net/2021/12/04/bSw9R3KHOt7Em6o.png)



![4](https://s2.loli.net/2021/12/04/trlfiARN5uVzeW7.png)





![5](https://s2.loli.net/2021/12/04/9zGWgiOFTvrod8a.png)
...
![1](https://s2.loli.net/2021/12/04/RdfVXkC2MOABm4Q.png)
...
![6](https://s2.loli.net/2021/12/05/QvSMB3Whb8cpPZY.png)
...
![2](https://s2.loli.net/2021/12/05/cjsKtr9kNpVYA78.png)
...
在套餐详情页面需要**展示当前套餐的信息**（包括图片、套餐名称、套餐介绍、适用性别、适用年龄）、此套餐**包含的检查组信息、检查组包含的检查项信息等。** 此过程**包含两个多对多的查询**
...
注意:其实这里imgUrl,按说数据库里面应该存放全路径的,因为图片可能经常的变化.
...
![71](https://s2.loli.net/2021/12/21/6qTZCDOIElQvL4X.png)

### 5.3 设置短信签名

注册成功后，点击登录按钮进行登录。登录后进入短信服务管理页面，选择国内消息菜单：

![72](https://s2.loli.net/2021/12/21/6Gp4WXD9g7Tarti.png)

点击添加签名按钮：

![73](https://s2.loli.net/2021/12/21/vLzlih4K6bysgTY.png)
...
![74](https://s2.loli.net/2021/12/21/QPVNYrcE4fOZ62G.png)

点击添加模板按钮：

![75](https://s2.loli.net/2021/12/21/KrZ3Rmp1Ghbc7eV.png)

### 5.5 设置access keys

在发送短信时需要进行身份认证，只有认证通过才能发送短信。本小节就是要设置用于发送短信时进行身份认证的key和密钥。鼠标放在页面右上角当前用户头像上，会出现下拉菜单：

![76](https://s2.loli.net/2021/12/21/UGRdLTi7MZvp3sN.png)

点击accesskeys：

![77](https://s2.loli.net/2021/12/21/t3TiP5DyQlGkNFY.png)

点击开始使用子用户AccessKey按钮：

![78](https://s2.loli.net/2021/12/21/aJtyHd3uWbnUGAR.png)

![79](https://s2.loli.net/2021/12/21/ZiT2GMc7PhmVonC.png)

![710](https://s2.loli.net/2021/12/21/ukSVdicto1DM2Zf.png)

![711](https://s2.loli.net/2021/12/21/miklWH9z4UdpBex.png)

创建成功，其中AccessKeyID为访问短信服务时使用的ID，AccessKeySecret为密钥。

可以在用户详情页面下禁用刚刚创建的AccessKey：

![712](https://s2.loli.net/2021/12/21/TrYmBOXcKtR8DZn.png)

可以设置每日和每月短信发送上限：

![713](https://s2.loli.net/2021/12/21/Q3gHzOTErLXhuYa.png)

由于短信服务是收费服务，所以还需要进行充值才能发送短信：

![714](https://s2.loli.net/2021/12/21/koH6yaOAMEFhUzB.png)
