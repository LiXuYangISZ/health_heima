...
![1](https://s2.loli.net/2021/12/15/PFSLW8zVJKetajX.png)
...
![2](https://s2.loli.net/2021/12/15/XvYx8foi6TWshlE.png)

下载完成可以得到如下文件：

![6](https://s2.loli.net/2021/12/22/UruTOb1PsFJMnRD.png)



解压上面的zip文件：

![7](https://s2.loli.net/2021/12/15/VqjFPhnRKHDXt18.png)



我们只需要将dist目录下的echarts.js文件引入到页面上就可以使用了

![8](https://s2.loli.net/2021/12/15/kB7olpPOZncAC3D.png)
...
![image-20211215164430953](https://s2.loli.net/2021/12/15/qG196mLdZ7CvjYu.png)
...
![3](https://s2.loli.net/2021/12/15/EMvHxXqgnKkmw1d.png)

可以点击具体的一个图形会跳转到编辑页面，编辑页面左侧展示源码（js部分源码），右侧展示图表效果，如下：

![4](https://s2.loli.net/2021/12/15/9XecNStLpHOPTVm.png)
...
![5](https://s2.loli.net/2021/12/15/jQOGWPT4ZsKbM6E.png)
