...
![1](https://s2.loli.net/2021/12/16/t1GCUnMhXygKuBW.png)
...
![2](https://s2.loli.net/2021/12/16/IbjAMhUx5cpfTzX.png)
...
![3](https://s2.loli.net/2021/12/16/rYUhbAklBRHXzmn.png)
...
methods:{
  //导出Excel报表
  exportExcel(){
      //这里由于是下载文件方式,所以不能使用传统的ajax方式.得来个同步的.
